...
description = "Run the Hypersphere ART clustering algorithm"


def run_single(inputs, targets, rho, r_bar, alpha, beta, max_epochs):
    # run HypersphereART and get labels
    fa = HypersphereART(rho, r_bar, alpha, beta, max_epochs=max_epochs, shuffle=False)
...
def evaluate(args):
    ...
    if args.restore_file is not None:
        ...
        params = list(itertools.product(rho, r_bar, alpha, beta))
